...
export const ANATOMY = {
  ...
  parts: {
    class: { title: 'class 키워드', body: '클래스 정의를 나타내는 키워드입니다. 반드시 소문자로 씁니다.', page: '교안 10쪽' },
    name: { title: '클래스명', body: '일반적으로 클래스 이름의 첫 문자는 대문자를 사용합니다. 예) Car, Dice, BankAccount', page: '교안 11쪽' },
    init: { title: '생성자 __init__', body: '인스턴스를 생성할 때 속성값을 초기화하는 메소드입니다. initialize 의 줄임말이고, 앞뒤로 밑줄 두 개씩 붙습니다. 클래스마다 하나만 정의할 수 있습니다.', page: '교안 14쪽' },
    self: { title: 'self 변수', body: '현재 인스턴스 자신을 참조합니다. 곧 「메소드를 호출한 인스턴스」입니다. 모든 메소드의 첫 번째 매개변수는 self 여야 합니다.', page: '교안 12~13쪽' },
    attr: { title: 'self.속성명', body: '메소드 안에서 속성을 쓸 때에는 속성명 앞에 self. 을 붙입니다. self. 을 빼면 그냥 메소드 안에서만 쓰는 임시 변수가 되어 버립니다.', page: '교안 12쪽' },
    method: { title: '메소드명', body: '클래스 안에 정의된 함수를 메소드라고 합니다. 첫 매개변수 self 뒤에 필요한 매개변수를 더 쓸 수 있습니다.', page: '교안 12쪽' },
  },
};

/* ── ④-4 객체 = 상태 + 동작 분류 활동 (교안 6쪽) ─────────────────────────── */
